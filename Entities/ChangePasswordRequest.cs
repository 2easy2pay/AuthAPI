   ...
   /// </summary>
    public class ChangePasswordRequest
    {
        ...
        public ChangePasswordRequest(string email, bool validateRequest,
            PasswordFormat newPasswordFormat, string newPassword, string oldPassword = "", string MobileNo = "")
        {
            this.Email = email;
        ...
        public ChangePasswordRequest(bool validateRequest,
           PasswordFormat newPasswordFormat, string newPassword, string MobileNo = "")
        {
            this.ValidateRequest = validateRequest;
            this.NewPasswordFormat = newPasswordFormat;
            this.NewPassword = newPassword;
